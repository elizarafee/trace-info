                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('first_name') is-invalid @enderror"
                                name="first_name" id="inputFirstName" @if(old('first_name'))
                                value="{{ old('first_name') }}" @elseif(isset($person->first_name)) value="{{
                            $person->first_name }}" @endif>
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="email" class="form-control @error('email') is-invalid @enderror" name="email"
                                id="inputEmail4" @if(old('email')) value="{{ old('email') }}"
                    ...
                    <!-- <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" class="form-control @error('address_line_2') is-invalid @enderror"
                                ...
                                @elseif(isset($person->address_line_2)) value="{{
                    ...
                    <div class="row">
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control  @error('phone') is-invalid @enderror" name="phone"
                                id="inputPhone" @if(old('phone')) value="{{ old('phone') }}"
                                @elseif(isset($person->phone))  value="{{ $person->phone }}" @endif>
